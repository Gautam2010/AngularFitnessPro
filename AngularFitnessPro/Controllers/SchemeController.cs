...
namespace AngularFitnessPro.Controllers
{
    ...
    public class SchemeController : ControllerBase
    {
        ...
        public SchemeController(ISchemeMaster schemeMaster,IMapper mapper)
        {
        ...
        public HttpResponseMessage Post([FromBody] SchemeMasterViewModel schemeMaster)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    //SchemeMaster tempSchemeMaster = new SchemeMaster();
                    //tempSchemeMaster.SchemeName = schemeMaster.SchemeName;
